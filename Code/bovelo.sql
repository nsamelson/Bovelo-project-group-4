...
CREATE TABLE User_value(id_user INTEGER NOT NULL,StateUser INTEGER,FirstName TEXT,LastName TEXT,UserLogin TEXT,UserPassword TEXT);
INSERT INTO User_value VALUES(1,0,"Jean","Dupond","205556","motdepassenonsecurise");
...
INSERT INTO User_value VALUES(5,1,"Herve","Dujardin","205560","motdepassenonsecurise");
